...
OdometryEstimator::OdometryEstimator() : Node("odometry_publisher")
{
  ...
  //odom_trans = std::make_unique<tf2_ros::TransformBroadcaster>(*this);
//
...
void OdometryEstimator::publish()
{
  ...
  //
  //odom_trans.transform.translation.x = new_state.x;
  //odom_trans.transform.translation.y = new_state.y;
  //odom_trans.transform.translation.z = 0.0;
  ////odom_trans.transform.rotation = quat.w();
//
  //// send the transform
